...
public class GUIAltaClienteNO_VIP extends JFrame {

	private String[] labels = { "Nombre", "Telefono", "Direccion", "DNI", "Lim. Credito" };
	private JTextField[] texts = new JTextField[labels.length];
	
	public GUIAltaClienteNO_VIP(){
		super();
		initGUI();
	}
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Alta Cliente No VIP"));
				...
				button.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (create) {
							...
							try {
							Controlador.getInstance().accion(Events.ALTA_CLIENTE_NO_VIP, 
									new TClienteNoVIP(out[0], Integer.parseInt(out[1]), out[2], true, out[3], Integer.parseInt(out[4])));
							} catch (Exception ex) {
