...
public class GUIAltaClienteVIP extends JFrame {

	private String[] labels = { "Nombre", "Telefono", "Direccion", "DNI", "Cod. Tarjeta" };
	private JTextField[] texts = new JTextField[labels.length];
	
	public GUIAltaClienteVIP(){
		super();
		initGUI();
	}
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Alta Cliente VIP"));
				...
				button.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (create) {
							...
							try {
							Controlador.getInstance().accion(Events.ALTA_CLIENTE_VIP, 
									new TClienteVIP(out[0], Integer.parseInt(out[1]), out[2], true, out[3], Integer.parseInt(out[4])));
							} catch (Exception ex) {
