...
public class GUIAltaMarca extends JFrame {
	...
	private String[] labels = { "IDPais", "Marca" };
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Alta Marca"));
				...
				button.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (create) {
							...
							try {
							Controlador.getInstance().accion(Events.ALTA_MARCA, 
									new TMarca(Integer.parseInt(out[0]), true, out[1], 0));
							} catch (Exception ex) {
