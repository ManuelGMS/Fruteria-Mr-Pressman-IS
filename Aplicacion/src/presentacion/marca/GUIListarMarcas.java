...
public class GUIListarMarcas extends JFrame {
	...
	private String[] columnNames = { "#", "Id", "Nombre", "IdPais" }; 
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Listar Marcas"));
			...
			button.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent e) {
					Controlador.getInstance().accion(Events.LISTAR_MARCA, null);
					toFront();
				}
	...
	public void update (ArrayList<TMarca> res){
		 tableModel.setRowCount(0);
		 for (int i = 0; i < res.size(); i++)
			 tableModel.insertRow(i, new Object[] 
					 { i, res.get(i).getId(), res.get(i).getNombre(), res.get(i).getIdPais() });
		 table.setModel(tableModel);
	}
