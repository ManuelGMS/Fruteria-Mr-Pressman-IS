...
public class GUIAltaPais extends JFrame {

	// All string below must have the same length so the label gonna be aligned
	private String[] labels = { "Nombre" };
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Alta Pais"));
				...
				button.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (create) {
							...
							try {
							Controlador.getInstance().accion(Events.ALTA_PAIS,
									new TPais(out[0], true, 0));
							} catch (Exception ex) {
