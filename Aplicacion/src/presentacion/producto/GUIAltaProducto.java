...
public class GUIAltaProducto extends JFrame {
	...
	private String[] labels = { "IdMarca", "Nombre", "Precio", "Unidades" };
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Alta Producto"));
				...
				button.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (create) {
							...
							try {
							Controlador.getInstance().accion(Events.ALTA_PRODUCTO, 
									new TProducto(Integer.parseInt(out[0]), out[1], Float.parseFloat(out[2]), Integer.parseInt(out[3]), true));
							} catch (Exception ex) {
