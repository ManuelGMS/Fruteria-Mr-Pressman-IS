...
CREATE TABLE marca (
	...
	nombre VARCHAR(30) NOT NULL,
	activo BIT NOT NULL,
	contador_productos INT NOT NULL,
...
ALTER TABLE marca ADD CONSTRAINT marca_pais_FK FOREIGN KEY (pais_id)
	REFERENCES pais (id)
	ON DELETE CASCADE;

ALTER TABLE producto ADD CONSTRAINT producto_marca_FK FOREIGN KEY (marca_id)
	REFERENCES marca (id)
	ON DELETE CASCADE;
